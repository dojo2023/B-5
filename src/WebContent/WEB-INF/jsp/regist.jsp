		...
		<body>
			...
			<div align="center">
				...
				<form method="POST" action="/sante/RegistServlet">
					<table class="regist_table" style="width: 423px; height: 746px;">
						<tr>
						...
						<tr>
							<td><label>生年月日:<br> <select name="year"
									onchange="handleIDInputChange()" class="regist_year">
						...
						<tr>
							<td><label> <a href="/sante/LoginServlet"
									id="regist_move">ログインはこちら</a>
							</label></td>
						</tr>
					</table>
				</form>
